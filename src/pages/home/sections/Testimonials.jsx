...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote:
        "Westfields Montessori has been a transformative experience for our daughter. The child-centered approach has nurtured her independence and love for learning in ways we never thought possible.",
      name: "Emily T.",
    ...
    {
      quote:
        "The teachers at Westfields truly understand each child's unique needs. My son, who struggled with traditional schooling, has flourished here, gaining confidence and a passion for discovery.",
      name: "Sarah M.",
      role: "Parent of a Student",
      image: "/testimonials/ama.webp",
      rating: 5,
    ...
    {
      quote:
        "I attended Westfields as a child, and the skills I learned—critical thinking, creativity, and self-motivation—have stayed with me into adulthood. I’m so grateful for the foundation this school gave me.",
      name: "Michael R.",
      role: "Alumni Student",
      image: "/testimonials/kofi.webp",
      rating: 4.5,
    ...
    {
      quote:
        "As a teacher at Westfields, I’ve seen firsthand how the Montessori method empowers children to take ownership of their learning. It’s a joy to witness their growth every day.",
      name: "Clara H.",
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 relative overflow-hidden">
      ...
      <motion.div
        ...
        animate={{ opacity: 0.6 }}
        transition={{ duration: 2 }}
        className="absolute top-10 -left-20 sm:-left-40 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-primaryGreen-light dark:bg-primaryGreen-dark blur-3xl opacity-10 mix-blend-multiply dark:mix-blend-screen"
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.4 }}
        transition={{ duration: 2, delay: 0.5 }}
        className="absolute bottom-10 -right-20 sm:-right-40 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-blue-400 dark:bg-blue-500 blur-3xl opacity-10 mix-blend-multiply dark:mix-blend-screen"
      />
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="font-ubuntu text-base sm:text-lg max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
            Hear from parents, alumni, and teachers about the impact of
            Westfields Montessori School on our children’s lives.
          </p>
        </motion.div>

        <div className="max-w-6xl mx-auto mb-8 sm:mb-12 md:mb-16 relative">
          <div className="absolute -top-10 sm:-top-16 -left-4 sm:-left-8 text-7xl sm:text-9xl opacity-5 text-primaryGreen-light dark:text-primaryGreen-dark">
            <FaQuoteLeft />
          </div>

          <div className="relative h-[500px] sm:h-[450px] md:h-[300px] overflow-hidden">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              <motion.div
                key={activeIndex}
                custom={direction}
              ...
              >
                <div className="md:w-1/3 mb-6 md:mb-0 flex justify-center">
                  <div className="relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-tr from-primaryGreen-light to-blue-400 dark:from-primaryGreen-dark dark:to-blue-500 rounded-full blur"></div>
                    <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-white dark:border-gray-800">
                      <img
                        src={testimonials[activeIndex].image}
                        alt={testimonials[activeIndex].name}
                        className="w-full h-full object-cover"
                    ...
                    <div className="absolute -bottom-2 right-0 backdrop-blur-xl bg-white dark:bg-gray-900 bg-opacity-80 dark:bg-opacity-80 rounded-full px-2 sm:px-3 py-1 shadow-lg border border-white dark:border-gray-700 flex items-center">
                      <div className="flex">
                        {renderRating(testimonials[activeIndex].rating)}
                      </div>
                    </div>
                ...
                <div className="md:w-2/3 md:pl-12">
                  <div className="backdrop-blur-xl bg-white dark:bg-gray-800 bg-opacity-50 dark:bg-opacity-20 border border-white border-opacity-40 dark:border-gray-700 rounded-3xl p-6 sm:p-8 shadow-lg">
                    <div className="text-primaryGreen-light dark:text-primaryGreen-dark mb-4">
                      <FaQuoteLeft size={20} className="sm:size-12" />
                    </div>
                    <p className="font-ubuntu text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-200 italic mb-6">
                      "{testimonials[activeIndex].quote}"
                    </p>
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                      <div>
                        <h4 className="font-montserrat font-semibold text-base sm:text-lg text-gray-800 dark:text-white">
                          {testimonials[activeIndex].name}
                        </h4>
                        <p className="text-primaryGreen-light dark:text-primaryGreen-dark font-medium text-sm sm:text-base">
                          {testimonials[activeIndex].role}
                        </p>
                      </div>
          ...
          <div className="flex justify-center items-center mt-8 sm:mt-10 space-x-3 sm:space-x-4">
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 sm:w-12 sm:h-12 rounded-full backdrop-blur-md bg-white dark:bg-gray-800 bg-opacity-70 dark:bg-opacity-30 border border-white border-opacity-40 dark:border-gray-700 shadow-lg flex items-center justify-center text-gray-800 dark:text-white"
              onClick={handlePrev}
              aria-label="Previous testimonial"
            >
              <svg
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${
                    index === activeIndex
                      ? "bg-primaryGreen-light dark:bg-primaryGreen-dark w-4 sm:w-6"
                      : "bg-gray-300 dark:bg-gray-600"
                  }`}
                  aria-label={`Go to testimonial ${index + 1}`}
                />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto">
          {[
            ...
            { number: "100%", label: "Holistic Growth" },
          ].map((stat, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.4, delay: index * 0.1 }}
              className="backdrop-blur-md bg-white dark:bg-gray-800 bg-opacity-40 dark:bg-opacity-20 border border-white border-opacity-40 dark:border-gray-700 rounded-xl p-4 sm:p-5 text-center shadow-md"
            >
              <p className="font-montserrat font-bold text-xl sm:text-2xl md:text-3xl mb-1 bg-gradient-to-r from-primaryGreen-light to-primaryGreen-hover-light dark:from-primaryGreen-dark dark:to-primaryGreen-hover-dark bg-clip-text text-transparent">
                {stat.number}
              </p>
