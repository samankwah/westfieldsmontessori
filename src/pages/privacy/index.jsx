...
const SCHOOL_DATA = {
  ...
  website: "https://westfieldsmontessori.com",
};

const Privacy = () => {
  const [activeSection, setActiveSection] = useState("introduction");
  const effectiveDate = "May 10, 2025"; // Updated to current date
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 sm:pt-24 pb-16 sm:pb-20">
      {/* Background pattern/gradient */}
      <div className="absolute inset-0 opacity-5 dark:opacity-10 -z-10">
        <div className="absolute top-0 w-full h-full bg-[url('/pattern-dots.png')] bg-repeat"></div>
      </div>
      ...
      <motion.div
        ...
        animate={{ opacity: 0.2 }}
        transition={{ duration: 2 }}
        className="fixed -top-16 sm:-top-20 -left-16 sm:-left-20 w-64 sm:w-80 h-64 sm:h-80 rounded-full bg-primaryGreen-light dark:bg-primaryGreen-dark blur-3xl opacity-10 dark:opacity-5 -z-5"
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.15 }}
        transition={{ duration: 2, delay: 0.5 }}
        className="fixed -bottom-16 sm:-bottom-20 -right-16 sm:-right-20 w-64 sm:w-80 h-64 sm:h-80 rounded-full bg-blue-400 dark:bg-blue-600 blur-3xl opacity-10 dark:opacity-5 -z-5"
      />
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3 }}
          className="mb-6 sm:mb-8 flex items-center text-xs sm:text-sm text-gray-600 dark:text-gray-400"
        >
          <Link
            to="/"
            className="flex items-center hover:text-primaryGreen-light dark:hover:text-primaryGreen-dark transition-colors"
          ...
          <FaChevronRight className="mx-1 sm:mx-2" />
          <span className="text-gray-800 dark:text-gray-200">
            Privacy Policy
          </span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.4, delay: 0.1 }}
            className="hidden lg:block w-64 sm:w-72 flex-shrink-0"
          >
            <div className="sticky top-20 sm:top-24">
              <div className="backdrop-blur-xl bg-white dark:bg-gray-800 bg-opacity-70 dark:bg-opacity-30 border border-white border-opacity-30 dark:border-gray-700 dark:border-opacity-20 rounded-3xl shadow-xl p-4 sm:p-6">
                <h3 className="font-montserrat font-semibold text-gray-800 dark:text-white text-base sm:text-lg mb-4 sm:mb-6 flex items-center">
                  <FaShieldAlt className="mr-2 text-primaryGreen-light dark:text-primaryGreen-dark" />
                  <span>Privacy Policy</span>
                </h3>
                ...
                <ul className="space-y-2">
                  {sections.map((section) => (
                    <li key={section.id}>
                      <button
                        onClick={() => scrollToSection(section.id)}
                        className={`w-full text-left py-2 px-3 sm:px-4 rounded-lg transition-all duration-200 text-xs sm:text-sm ${
                          activeSection === section.id
                            ? "bg-primaryGreen-light dark:bg-primaryGreen-dark text-white font-medium shadow-md"
                            : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:bg-opacity-50 dark:hover:bg-opacity-50"
                        }`}
          ...
          >
            ...
            <div className="lg:hidden mb-6 sm:mb-8">
              ...
              <select
                ...
                value={activeSection}
                onChange={(e) => scrollToSection(e.target.value)}
                className="w-full p-2 sm:p-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-primaryGreen-light dark:focus:ring-primaryGreen-dark"
              >
                {sections.map((section) => (
                  <option key={section.id} value={section.id}>
                    {section.title}
            ...
            {/* Privacy policy content */}
            <div className="backdrop-blur-xl bg-white dark:bg-gray-800 bg-opacity-70 dark:bg-opacity-30 border border-white border-opacity-30 dark:border-gray-700 dark:border-opacity-20 rounded-3xl shadow-xl p-6 sm:p-8 md:p-12">
              {/* Title banner */}
              <div className="mb-8 sm:mb-12 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-primaryGreen-light to-primaryGreen-hover-light dark:from-primaryGreen-dark dark:to-primaryGreen-hover-dark text-white">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full bg-white bg-opacity-20 flex items-center justify-center">
                    <FaShieldAlt size={20} className="sm:size-24" />
                  </div>
                  <h1 className="text-2xl sm:text-3xl font-montserrat font-bold ml-3 sm:ml-4">
                    Westfields Montessori School Privacy Policy
                  </h1>
                </div>
                <p className="text-white text-opacity-90 font-Ubuntu text-sm sm:text-base">
                  Effective Date: {effectiveDate}
                </p>
              </div>
              ...
              <section id="introduction" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  1. Introduction
                </h2>
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <p>
                    Welcome to <strong>Westfields Montessori School</strong>{" "}
                    ("the School"), dedicated to providing an inclusive and
                    child-centered education. This Privacy Policy explains how
              ...
              {/* Section: Information We Collect */}
              <section id="information-we-collect" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  2. Information We Collect
                </h2>

                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mt-4 sm:mt-6 mb-3">
                    2.1 Personal Information
                  </h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="mt-1 sm:mt-1.5 mr-2 sm:mr-3 text-primaryGreen-light dark:text-primaryGreen-dark">
                        <FaCheck size={12} className="sm:size-14" />
                      </span>
                      <span>
                        <strong>Enrollment Data:</strong> We collect names,
                        contact details, and emergency contacts when you enroll
                        a child.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Communication Data:</strong> Emails or inquiries
                        submitted via our website or contact forms.
                      </span>
                    </li>
                  </ul>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Website Analytics:</strong> Anonymized data
                        (e.g., page views) to improve our website, collected via
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Enrollment and Support:</strong> To process
                        applications, communicate with parents, and provide
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        patterns and enhance the user experience.
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              {/* Section: Data Sharing and Disclosure */}
              <section id="data-sharing" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  4. Data Sharing and Disclosure
                </h2>
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  ...
                  <p>
                    We may share limited data with third-party services (e.g.,
                    payment processors, analytics tools) strictly to fulfill
                    necessary functions. These services are bound by their own
                    privacy policies.
                  </p>
              ...
              <section id="third-party" className="mb-8 sm:mb-12">
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <p>
                    Westfields Montessori School uses third-party services such
                    as Google Analytics to improve our website. These services
                    may collect anonymized data, and their use is subject to
              ...
              <section id="cookies" className="mb-8 sm:mb-12">
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <p>
                    ...
                    for analytics). You can manage your cookie preferences
                    through your browser settings. For more details, please
                    refer to our{" "}
                    <Link
                      to="/cookies-policy"
                      className="text-primaryGreen-light dark:text-primaryGreen-dark hover:underline"
              ...
              {/* Section: Children's Privacy */}
              <section id="childrens-privacy" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  7. Children's Privacy
                </h2>
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <p>
                    Westfields Montessori School primarily serves children aged
                    2 to 12. We collect limited personal information (e.g.,
                    names, birth dates) solely for enrollment and educational
                    purposes, with parental consent. We do not knowingly collect
                    additional personal data from children. If you believe we
                    have collected unnecessary data, please contact us to have
                    it removed.
                  </p>
                </div>
              </section>
              ...
              {/* Section: Data Security */}
              <section id="data-security" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  8. Data Security
                </h2>
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Secure Storage:</strong> Enrollment data is
                        stored in secure systems with restricted access.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="mt-1 sm:mt-1.5 mr-2 sm:mr-3 text-primaryGreen-light dark:text-primaryGreen-dark">
                      ...
                      <span>
                        <strong>Secure Communication:</strong> We use secure
                        protocols (HTTPS) for online transactions and
                        communications.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        data necessary for educational and administrative
                        purposes.
                      </span>
                    </li>
                  </ul>
              ...
              <section id="changes" className="mb-8 sm:mb-12">
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <p>
                    ...
                    practices or legal requirements. Changes will be
                    communicated by updating the "Effective Date" above. We
              ...
              {/* Section: Your Choices */}
              <section id="your-choices" className="mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl font-montserrat font-bold text-gray-800 dark:text-white mb-4">
                  10. Your Choices
                </h2>
                ...
                <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none font-Ubuntu text-gray-600 dark:text-gray-300">
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Data Access and Correction:</strong> Parents can
                        request access to or correction of their child’s data by
                        contacting us.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Opt-Out:</strong> You may opt out of
                        non-essential communications (e.g., newsletters) by
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  <div>
                    <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">
                      By engaging with Westfields Montessori School, you
