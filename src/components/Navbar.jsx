...
//         className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
//           isScrolled
//             ? "py-2 bg-white bg-opacity-90 dark:bg-gray-900 dark:bg-opacity-90 shadow-lg backdrop-blur-md"
//             : "py-4 bg-transparent"
//         }`}
//       >
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
//             {/* Logo */}
//             <div className="flex-shrink-0 flex items-center">
//               <div className="h-12 w-12 rounded overflow-hidden bg-transparent shadow-md">
//                 <img
...
//                   Westfields
//                 </span>
//                 <span className="text-xs font-montserrat text-secondary-light dark:text-secondary-dark">
//                   Montessori School
//                 </span>
//               </div>
//             </div>
...
//                     className={`font-medium transition-colors relative ${
//                       isScrolled
//                         ? "text-gray-800 hover:text-primary-light dark:text-gray-100 dark:hover:text-primary-dark"
//                         : "text-gray-900 dark:text-gray-100 hover:text-primary-light dark:hover:text-primary-dark"
//                     } ${
//                       isActive
...
//                     {link.name}
//                     <motion.span
//                       className="absolute bottom-0 left-0 w-full h-0.5 bg-primary-light dark:bg-primary-dark rounded-full"
//                       animate={{
//                         width: isActive ? "100%" : "0%",
//                         opacity: isActive ? 1 : 0,
//                       }}
...
//             {/* Theme Toggle and Parent Portal Button */}
//             <div className="hidden md:flex md:items-center md:space-x-4">
//               <button
//                 onClick={toggleTheme}
//                 className={`p-2 rounded-full transition-colors ${
...
//                     : "text-white dark:text-gray-100 hover:bg-white hover:bg-opacity-20 dark:hover:bg-gray-700 dark:hover:bg-opacity-20"
//                 }`}
//                 aria-label="Toggle theme"
//               >
//                 {theme === "light" ? <FiMoon size={20} /> : <FiSun size={20} />}
...
//               <a
//                 href="/parent-portal"
//                 className={`transition-all duration-300 font-medium py-2 px-6 rounded-full flex items-center ${
//                   isScrolled
//                     ? "bg-primary-light dark:bg-primary-dark text-gray-900 dark:text-white hover:bg-primary-hover-light dark:hover:bg-primary-hover-dark"
...
//                       alt="Westfields Montessori School Logo"
//                     />
//                     <span className="ml-2 text-lg font-montserrat font-bold text-primary-light dark:text-primary-dark">
//                       Westfields
//                     </span>
//                   </div>
//                   <button
...
//                         className={`block px-4 py-3 text-base font-medium rounded-lg transition-colors relative ${
//                           isActive
//                             ? "bg-primary-light bg-opacity-10 dark:bg-primary-dark dark:bg-opacity-20 text-primary-light dark:text-primary-dark"
//                             : "text-gray-800 dark:text-gray-100 hover:bg-primary-light hover:bg-opacity-5 dark:hover:bg-primary-dark dark:hover:bg-opacity-10"
//                         }`}
//                         onClick={() => setMobileMenuOpen(false)}
//                       >
//                         <motion.span
//                           className="absolute left-0 top-0 bottom-0 w-1 bg-primary-light dark:bg-primary-dark rounded-r-full"
//                           animate={{
//                             opacity: isActive ? 1 : 0,
//                             height: isActive ? "100%" : "0%",
//                           }}
...
//                   <a
//                     href="/calendar"
//                     className="block px-4 py-3 text-base font-medium rounded-lg transition-colors text-gray-800 dark:text-gray-100 hover:bg-primary-light hover:bg-opacity-5 dark:hover:bg-primary-dark dark:hover:bg-opacity-10"
//                     onClick={() => setMobileMenuOpen(false)}
//                   >
//                     School Calendar
//                   </a>
...
//                   <a
//                     href="/parent-portal"
//                     className="w-full bg-primary-light dark:bg-primary-dark text-gray-900 dark:text-white hover:bg-primary-hover-light dark:hover:bg-primary-hover-dark font-medium py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center"
//                     onClick={() => setMobileMenuOpen(false)}
//                   >
//                     <FaGraduationCap className="mr-2" />
//                     Parent Portal
